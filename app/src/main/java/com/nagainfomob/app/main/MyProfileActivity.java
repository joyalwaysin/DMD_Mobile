...
public class MyProfileActivity extends AppCompatActivity implements View.OnClickListener, BottomSheetLAAdapter.ItemListener {

    private final AppCompatActivity activity = MyProfileActivity.this;
...
//                Toast.makeText(this, "Cropping failed: " + result.getError(), Toast.LENGTH_LONG).show();
    ...
    public void getCountryList() {
        try {
            ...
            chooseCountryAdapter = new BottomSheetLAAdapter(ChooseCountryList, MyProfileActivity.this);
            recyclerViewCountry.setAdapter(chooseCountryAdapter);
...
//                        input_company_county.setText(null);
    ...
    private void getDatafromdb(){
        ...
        company = DatabaseManager.getCompany(activity, session.getUserID());
        ...
        input_email.setText(user.get(0).getEmail());
        input_company_name.setText(company.get(0).getComp_name());
        input_company_desc.setText(company.get(0).getComp_desc());
        input_company_address.setText(company.get(0).getComp_addr1());
        input_company_phone.setText(company.get(0).getComp_phone_number());
        hidden_ccd.setText(company.get(0).getComp_country_code());
        input_company_county.setText(company.get(0).getComp_country_name());
