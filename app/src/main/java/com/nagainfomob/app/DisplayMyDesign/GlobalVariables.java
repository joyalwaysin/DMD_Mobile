...
//	 static String apiURL = "http://crossrangetalk.com/api/";//test
    ...
    static String designerUnit = null;
    ...
    static String imageRoot = Environment.getExternalStorageDirectory()
            .getAbsolutePath() + "/DMD/";
    static String imageRootPattern = Environment.getExternalStorageDirectory()
            .getAbsolutePath() + "/DMD/Custom__Pattern/";
...
//        return 1024;
    ...
    public static void setDesignerUnit(String unit) {
        designerUnit = unit;
    }

    public static String getDesignerUnit() {
        return designerUnit;
    }
    ...
    public static String getCustomPatternRootPath() {
        return imageRootPattern;
    }
    ...
    public static float inchToFeet(float mm) {
        float feet = mm / 12f;
        String feets = String.format("%1.2f", feet);
        feet = Float.parseFloat(feets);
        return feet;
    ...
    public static float feetToInches(float value) {
        float inches = value * 12f;
        String inch = String.format("%1.2f", inches);
        inches = Float.parseFloat(inch);
        return inches;
    }
