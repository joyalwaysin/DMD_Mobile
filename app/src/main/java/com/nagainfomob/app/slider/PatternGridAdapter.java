...
import com.nagainfomob.app.DisplayMyDesign.EditAmbienceWall;
...
import com.nagainfomob.app.DisplayMyDesign.ViewPatternActivity;
...
public class PatternGridAdapter extends BaseAdapter implements Checkable {
	...
	public PatternGridAdapter(Activity activity,
							  ArrayList<HashMap<String, String>> dbResult,
							  CustomPatternActivity customPatternActivity) {
		this.activity = activity;
		this.dbResult = dbResult;
		this.delegate = customPatternActivity;
		inflater = (LayoutInflater) activity
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		// imageLoader = new ImageLoader(this.activity.getApplicationContext());
		initimageloader();
	...
	public PatternGridAdapter(Activity activity,
							  ArrayList<HashMap<String, String>> dbResult,
							  AmbienceBathroom01 editAmbienceWall) {
		this.activity = activity;
		this.dbResult = dbResult;
		inflater = (LayoutInflater) activity
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	...
	public PatternGridAdapter(Activity activity,
							  ArrayList<HashMap<String, String>> dbResult,
							  AmbienceExterior01 editAmbienceWall) {
		this.activity = activity;
		this.dbResult = dbResult;
		inflater = (LayoutInflater) activity
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	...
	public PatternGridAdapter(Activity activity,
							  ArrayList<HashMap<String, String>> dbResult,
							  AmbienceKitchen01 editAmbienceWall) {
		this.activity = activity;
		this.dbResult = dbResult;
		inflater = (LayoutInflater) activity
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//		(MainActivity) getActivity()).
		...
		imageLoader.displayImage("file:///"+path, i, options);
//		ImageLoader.getInstance().displayImage("file:///"+path, i, options);
			...
			public void onClick(View v) {
				...
				if (activity.getClass().equals(ViewPatternActivity.class)) {
					...
					try {
						...
						callDeligate(path, tDim, tBrand, tType, tile_id, tile_type, tile_price);
					} catch (Exception e) {
	...
	public void callDeligate(String path, String Dim, String brand, String type, String tile_id,
							 String tile_type, String tile_price) {
		this.delegate.patternName(path, Dim, brand, type, tile_id, tile_type, tile_price);
	}
