...
public class FragFrontView extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view1 = inflater.inflate(R.layout.sanitary_bg, container, false);
		...
		Bitmap bitmap = BitmapFactory.decodeFile(Environment
				...
				+ GlobalVariables.getProjectName() + "-Front" + ".png");
		BitmapDrawable bd = new BitmapDrawable(res, bitmap);
		view = (RelativeLayout) view1.findViewById(R.id.container);
	...
	private void initialise() {
		...
		patternScrollView = (LinearLayout) view1.findViewById(R.id.ScrollView);
		content_slider = (LinearLayout) view1.findViewById(R.id.slider);
	...
	private void saveView() {
		...
		file = new File(myDir, "FrontWall_" + ViewSelector.time + ".jpg");
		// Log.i(TAG, "" + file);
		if (file.exists())
			file.delete();
		try {
	...
	// ArrayList<String> assetfoldersList = new ArrayList<String>();
	...
	public class MyScaleGestures implements OnTouchListener,
		...
		public boolean onScale(ScaleGestureDetector detector) {
			// Log.d("TAG", detector.getScaleFactor()+"");
