...
public class FragLeftView extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view2 = inflater.inflate(R.layout.sanitary_bg, container, false);
		...
		Bitmap bitmap = BitmapFactory.decodeFile(Environment
				...
				+ GlobalVariables.getProjectName() + "-Left" + ".png");
		BitmapDrawable bd = new BitmapDrawable(res, bitmap);
		view = (RelativeLayout) view2.findViewById(R.id.container);
	...
	private void initialise() {
		...
		patternScrollView = (LinearLayout) view2.findViewById(R.id.ScrollView);
		content_slider = (LinearLayout) view2.findViewById(R.id.slider);
	...
	private void saveView() {
		...
		file = new File(myDir, "LeftWall_" + ViewSelector.time + ".jpg");
		// Log.i(TAG, "" + file);
		if (file.exists())
			file.delete();
		try {
