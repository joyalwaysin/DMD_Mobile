...
public class FragBackView extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view3 = inflater.inflate(R.layout.sanitary_bg, container, false);
        ...
        Bitmap bitmap = BitmapFactory.decodeFile(Environment
                ...
                + GlobalVariables.getProjectName() + "-Back" + ".png");
        BitmapDrawable bd = new BitmapDrawable(res, bitmap);
        view = (RelativeLayout) view3.findViewById(R.id.container);
...
//					flag12=1;
    ...
    private void initialise() {
        ...
        patternScrollView = (LinearLayout) view3.findViewById(R.id.ScrollView);
        content_slider = (LinearLayout) view3.findViewById(R.id.slider);
...
//		RelativeLayout rel = (RelativeLayout) view4.findViewById(R.id.container);
        view3.setDrawingCacheEnabled(true);
        view3.buildDrawingCache();
        Bitmap bitmap = view3.getDrawingCache();
...
//			GlobalVariables.createNomediafile(ViewSelector.foldername);
        ...
        file = new File(myDir, "BackWall_" + ViewSelector.time + ".jpg");
//		Log.i(TAG, "" + file);
        if (file.exists())
            file.delete();
        try {
        ...
        if (string.length() > 0) {
            for (int z = 0; z < f.size(); z++) {
                ...
                if (fromList.toUpperCase().contains(string.toUpperCase())
                        || fromList.toLowerCase().contains(string.toLowerCase())) {
                    paths.add(f.get(z));
                    names.add(g.get(z));
                }
            }
...
//						 setPath.get(position), 1000).show();
                // .show();
                flag = 1;
